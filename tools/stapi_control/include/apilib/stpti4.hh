...
/* File Name   : stpti.h                                                     */
/*                                                                           */
/* Description : stpti driver header file                                    */
/*                                                                           */
/*                                                                           */
/* Component   : STPTI4                                                      */
/* Module      :                                                             */
...
/*                                                                           */
/*****************************************************************************/
#ifndef STPTI_REVISION

/* STPTI4 driver version */
#define STPTI_REVISION "STPTI4-REL_8.5.6"

#endif /* STPTI_REVISION */

#ifndef STPTI_TC_REVISION

/* STPTI4 TC firmware version */
#define STPTI_TC_REVISION 56

/* Validate the TC firmware version used */
#if (STPTI_TC_REVISION == 0)
#error Incompatible TC firmware version found !!!
#endif

#endif /* STPTI_TC_REVISION */
...
#define STPTI_DVB_API_SUPPORT



#if defined (STPTI_DVB_API_SUPPORT)
#define STPTI_VARIANT "DVB"
#else
#error VARIANT support is not defined in the STPTI_CONFIG !!!
#endif
...
#else
#if defined(ST_5100) || defined(ST_5101) || defined(ST_5200) || defined(ST_5301) || defined(ST_7710) || defined(ST_7100) || defined(ST_5197)
...
#else
#if defined(ST_5206) || defined(ST_5289) || defined(ST_7105) ||defined(ST_7106) || defined(ST_7111) || defined(ST_7141) || defined(ST_7200)
...
#if defined(ST_5100) || defined(ST_5101) || defined(ST_5197) || defined(ST_5200) || defined(ST_5202) || defined(ST_5206) ||    defined(ST_5289) || defined(ST_5301) || defined(ST_5528) || defined(ST_7710) || defined(ST_7100) || defined(ST_7101) ||    defined(ST_7105) || defined(ST_7106) || defined(ST_7109) || defined(ST_7111) || defined(ST_7141)
...
#define STPTI_CAROUSEL_ARCHITECTURE 2
#else
#define STPTI_CAROUSEL_ARCHITECTURE 1
#endif
...
*/
#if defined(ST_5100) || defined(ST_5101) || defined(ST_5197) || defined(ST_5200)  || defined(ST_5206) || defined(ST_5289) || defined(ST_5301) || defined(ST_7710) || defined(ST_7100) || defined(ST_7120) || defined(ST_7111)

    #define STPTI_CORE_COUNT    1

#else
#if defined(ST_5202) || defined(ST_5528) || defined(ST_7101) || defined(ST_7105) || defined(ST_7106) || defined(ST_7109) || defined(ST_7141) || defined(ST_7200)
...
#if !(defined(ST_7100) || defined(ST_5197))
...
/* used for backward compatibility, should be subscribed with either timed entry event or entry complete event and not both */
#define STPTI_EVENT_CAROUSEL_TIMED_ENTRY_EVT    (STPTI_EVENT_CAROUSEL_ENTRY_COMPLETE_EVT) 
...
typedef enum STPTI_StreamID_s
{
    ...
    STPTI_STREAM_ID_TSIN1,
    STPTI_STREAM_ID_TSIN2,
#if defined(ST_5206) || defined(ST_5289) || defined(ST_7105) || defined(ST_7106) || defined(ST_7111) || defined(ST_7141)
    STPTI_STREAM_ID_TSIN3,
#endif
#if defined(ST_5528)
    STPTI_STREAM_ID_TSIN3,
...
#if defined(ST_5197) || defined(ST_5206) || defined(ST_5289) || defined(ST_7101) || defined(ST_7105) ||    defined(ST_7106) || defined(ST_7109) || defined(ST_7111) || defined(ST_7141)
    STPTI_STREAM_ID_SWTS0,
    STPTI_STREAM_ID_SWTS1,
    STPTI_STREAM_ID_SWTS2,
#endif
...
#if (STPTI_CAROUSEL_ARCHITECTURE == 1)
#define STPTI_CAROUSEL_MAX_PARALLEL_ENTRIES_SUPPORTED (1)
#else
#if (STPTI_CAROUSEL_ARCHITECTURE == 2)
#define STPTI_CAROUSEL_MAX_PARALLEL_ENTRIES_SUPPORTED (3)
#endif
#endif

typedef struct STPTI_CarouselEntryProcessParams_s
{
    ...
    U16                     EntryDataSize;
    U16                     FromByte;
    U32                     MinCarouselTimeMilliSec;
    U32                     MaxCarouselTimeMilliSec;    
    BOOL                    EventOnOutput;
    BOOL                    EventOnTimeout;
    U32                     PrivateData;
} STPTI_CarouselEntryProcessParams_t;
...
typedef union STPTI_IndexDefinition_s
{
    struct
    {
        ...
        /* PTI does NOT generate these events
         * Strasp uses this structure, and it does...
         */
        U32 StraspTimerTick:1; /* STRASP generated */
        U32 StraspPacketReplaced:1; /* STRASP generated */
...
typedef struct STPTI_IndexEventData_s
{
    ...
    U32                     FRP_PacketArrivalTime;          /* used by strasp only */
...
typedef enum STPTI_Feature_e
{
    ...
    /* Session Features.....................*/
    STPTI_SESSION_FEATURE_ALLOW_TP_ERR_PKTS,
...
{
    BOOL ForceTermination;           /* Force termination even if any objects are associated */
...
typedef struct
{
    ...
    U32 CarouselEntryCompleteEventCount;
    U32 CarouselEntryTimeoutEventCount;
#if (STPTI_CAROUSEL_ARCHITECTURE == 1)
    U32 CarouselEntryCycleEventCount;
#endif    
...
#else
#define STPTI_AlternateOutputSetDefaultAction( a, b, c )   ST_NO_ERROR
#endif
...
#else
#define STPTI_BufferAllocateManual( a, b, c, d, e )   ST_NO_ERROR
#endif
...
#else
#define STPTI_BufferExtractData( a, b, c, d, e, f, g, h, i )   ST_NO_ERROR
#endif
...
#else
#define STPTI_BufferExtractTSHeaderData( a, b )   ST_NO_ERROR
#endif
...
#else
#define STPTI_BufferGetFreeLength( a, b )         ST_NO_ERROR
#endif
...
#else
#define STPTI_BufferLinkToCdFifo( a, b )       ST_NO_ERROR
#endif
...
ST_ErrorCode_t STPTI_BufferReadPes(STPTI_Buffer_t BufferHandle, U8 *Destination0_p, U32 DestinationSize0,
                                   U8 *Destination1_p, U32 DestinationSize1, U32 *Datasize_p, STPTI_Copy_t DmaOrMemcpy);
#else
#define STPTI_BufferPacketCount( a, b )   ST_NO_ERROR
#define STPTI_BufferRead( a, b, c, d, e, f, g )   ST_NO_ERROR
#define STPTI_BufferReadNBytes( a, b, c, d, e, f, g, h )   ST_NO_ERROR
...
#else
#define STPTI_BufferSetMultiPacket( a, b )   ST_NO_ERROR
#endif
...
ST_ErrorCode_t STPTI_CarouselProcessEntry(  STPTI_Carousel_t CarouselHandle, 
                                            STPTI_CarouselEntry_t CarouselEntry, 
                                            STPTI_CarouselEntryProcessParams_t EntryParams);
...
#else
#define STPTI_SetSystemKey( a, b )                  ST_NO_ERROR
...
#define STPTI_DescramblerSetSVP( a , b , c, d )     ST_NO_ERROR
#define STPTI_EnableScramblingEvents( a )           ST_NO_ERROR
#define STPTI_DisableScramblingEvents( a )          ST_NO_ERROR
#endif /* #if defined ( STPTI_BSL_SUPPORT ) */
...
#else
#define STPTI_GetCapability( a, b )         ST_NO_ERROR
#define STPTI_GetCurrentPTITimer( a, b )    ST_NO_ERROR
#endif
...
#else
#define STPTI_GetGlobalPacketCount( a, b )    ST_NO_ERROR
#define STPTI_GetInputPacketCount( a , b )    ST_NO_ERROR
#define STPTI_GetStatistics( a, b )           ST_NO_ERROR
#endif
...
#else
#define STPTI_GetPacketArrivalTime( a, b, c )   ST_NO_ERROR
#endif
...
#else
#define STPTI_GetPresentationSTC( a, b, c )   ST_NO_ERROR
#endif

#if !defined ( STPTI_BSL_SUPPORT )
ST_ErrorCode_t STPTI_HardwarePause(ST_DeviceName_t DeviceName);
#else
#define STPTI_HardwarePause( a )   ST_NO_ERROR
#endif
...
#else
#define STPTI_HardwareFIFOLevels( a, b, c, d, e )   ST_NO_ERROR
#define STPTI_HardwareReset( a )                    ST_NO_ERROR
#define STPTI_HardwareResume( a )                    ST_NO_ERROR
#endif

#ifndef STPTI_BSL_SUPPORT
...
/* If ReplaceWith is NULL, or ReplaceCount == 0, then has behaviour of old
 * BufferReadTSatOffset - no packet mangling */
/* If PacketBuffer_p is NULL then no capture can be performed, but packet
 * mangling will take place iff Replace parameters are viable
 */
...
#else
#define STPTI_ModifySyncLockAndDrop( a, b, c )   ST_NO_ERROR
#endif
...
#else
#define STPTI_ObjectEnableFeature( a, b )   ST_NO_ERROR
#define STPTI_ObjectDisableFeature( a, b )   ST_NO_ERROR
#endif
...
#else
#define STPTI_ResetStatistics( a )  ST_NO_ERROR
#define STPTI_SetStreamID( a, b )   ST_NO_ERROR
#define STPTI_PidQuery( a, b, c )   ST_NO_ERROR
#endif
...
#define STPTI_SlotForceSCB(a, b, c)                ST_NO_ERROR
#define STPTI_SlotCancelForceSCB( a )              ST_NO_ERROR
#endif
...
#else
#define STPTI_SlotLinkToCdFifo(a, b )                ST_NO_ERROR
#define STPTI_SlotLinkSecondaryToPrimary  (a, b, c ) ST_NO_ERROR
#define STPTI_SlotUnLinkSecondaryToPrimary(a, b )    ST_NO_ERROR
#endif 
...
#else
#define STPTI_SlotSetCCControl( a, b )             ST_NO_ERROR
#define STPTI_SlotSetCorruptionParams( a, b, c )   ST_NO_ERROR
#endif
...
#else
#define STPTI_UserDataBlockMove( a, b, c )                ST_NO_ERROR
#define STPTI_UserDataCircularAppend( a, b, c )           ST_NO_ERROR
#define STPTI_UserDataCircularSetup( a, b, c, d, e, f )   ST_NO_ERROR
#define STPTI_UserDataSynchronize( a )                    ST_NO_ERROR
#define STPTI_UserDataWrite( a, b, c )                    ST_NO_ERROR
#define STPTI_UserDataRemaining( a, b )                   ST_NO_ERROR
...
#else
#define STPTI_GetBuffersFromSlot( a, b, c )   ST_NO_ERROR
#endif
...
#else
#define STPTI_FrontendUnLink( a )          ST_NO_ERROR
#define STPTI_FrontendDeallocate( a )      ST_NO_ERROR
#endif
#endif /* #if defined (STPTI_FRONTEND_HYBRID) ... #endif */
