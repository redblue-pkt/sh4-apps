...
#define STLAYER_NUMBER_OF_CEH_INTERVALS 32
...
enum
{
    ...
    /* This event passes a (STLAYER_TakeRelease_t *) as parameter */
    STLAYER_TAKE_RELEASE_EVT,
    /* This event passes a (ST_DeviceName_t *) as parameter */
...
typedef enum STLAYER_Layer_e
{
    ...
    STLAYER_HQVDPLITE_VIDEO1,       /* Main HD for H205 */
...
typedef U32 STLAYER_PictureBufferHandle_t;  /* Note that STLAYER_PictureBufferHandle_t is identical to STVID_PictureBufferHandle_t */
...
{
    /* The viewport will be locked until either:
      - a new picture is received after the VP was closed and opened again.
      - a call to unlock is done     */
    STLAYER_AUTOMATIC_UNLOCK_WITH_NEW_PICTURE_RECEIVED,
    /* The VP is locked until unlock is specifically called. Do not unlock automatically */
...
typedef struct STLAYER_Field_s
{
    ...
    U32                             PictureIndex;
    STLAYER_PictureBufferHandle_t   PictureBufferHandle;
    U32                             PictureSignature;                   /* Signature computed on all the frame */
...
typedef struct STLAYER_StreamingVideo_s
{
    ...
    /* 3D Properties for cross conversions */
    ...
    U32                                 PictureSignature;                   /* Obsolete field not used anymore. Signature is now in CurrentField */
    ...
    BOOL                                SrcDiscontinuity;                   /* TRUE when there is a break in the input picture flow */
    BOOL                                IsPanoramicModeRequested;
    /* Dynamic constrast histogram registers */
    U32                                 CEHRegisters[STLAYER_NUMBER_OF_CEH_INTERVALS];
...
typedef struct STLAYER_ColorBoostParameters_s {
                                /* -100% = Max decrease of color. (divided by 2)  */
                                /*    0% = No effect.                   */
                                /*  100% = Max Increase of color (multiplied by 2).  */
    S32 RedBoost;
    S32 GreenBoost;
    S32 BlueBoost;
...
typedef struct STLAYER_IQI_LEParameters_s
{
    ...
    BOOL                        IsAutoCurveEnabled; /* Is Contrast Enhancer Auto Curve used ? */
    STLAYER_ContrastAutoCurve_t AutoCurveType;      /* Contrast Enhancer Auto Curve Type */
    STLAYER_IQI_LEAutoCurve_t   AutoCurveParams;    /* Auto Curve for Contrast Enhancer */
    U8                          AutoCurveCSCGain;   /* Global chroma weight gain (From 0 to 31) */
...
typedef enum STLAYER_ViewportType_e
{
	STLAYER_VIEWPORT_GDP,
	STLAYER_VIEWPORT_VBI,

} STLAYER_ViewportType_t;
...
ST_ErrorCode_t STLAYER_SetViewPortType (
  STLAYER_ViewPortHandle_t                   VPHandle,
  STLAYER_ViewportType_t					 ViewPortType);
...
typedef struct STLAYER_HQVDPLiteCommand_s
{
    struct
    {
        U32 Config;             /* Only TOP_NOT_BOT bit is dynamic */
        U32 MemFormat;          /* Dynamic */
        U32 CurrentLuma;        /* Dynamic */
        U32 Current_Enh_Luma;        /* Dynamic */
        U32 Current_Right_Luma;        /* Dynamic */
        U32 Current_Right_Enh_Luma;        /* Dynamic */
        U32 CurrentChroma;      /* Dynamic */
        U32 Current_Enh_Chroma;        /* Dynamic */
        U32 Current_Right_Chroma;        /* Dynamic */
        U32 Current_Right_Enh_Chroma;        /* Dynamic */
        U32 OutputLuma;         /* Dynamic */
        U32 OutputChroma;         /* Dynamic */
        U32 LumaSrcPitch;       /* Dynamic */
        U32 LumaEnhSrcPitch;       /* Dynamic */
        U32 LumaRightSrcPitch;       /* Dynamic */
        U32 LumaRightEnhSrcPitch;       /* Dynamic */
        U32 ChromaSrcPitch;     /* Dynamic */
        U32 ChromaEnhSrcPitch;     /* Dynamic */
        U32 ChromaRightSrcPitch;     /* Dynamic */
        U32 ChromaRightEnhSrcPitch;     /* Dynamic */
        U32 LumaProcessedPitch;     /* Dynamic */
        U32 ChromaProcessedPitch;     /* Dynamic */
        U32 InputFrameSize;     /* Dynamic */
        U32 InputViewportOri;   /* Dynamic */
        U32 InputViewportOriRight;   /* Dynamic */
        U32 InputViewportSize;  /* Dynamic */
        U32 LeftViewBorderWidth;  /* Dynamic */
        U32 RightViewBorderWidth;  /* Dynamic */
        U32 LeftView3doffsetWidth;  /* Dynamic */
        U32 RightView3doffsetWidth;  /* Dynamic */
        U32 SideStripColor;  /* Dynamic */
        U32 CrcResetCtrl;       /* Dynamic */
    } Top;
    struct
    {
    ...
    struct
    {
        ...
        U32 ViewportSize;       /* Dynamic */
        U32 NextNextLuma;       /* Dynamic */
        U32 NextNextRightLuma;       /* Dynamic */
        U32 NextNextNextLuma;   /* Dynamic */
        U32 NextNextNextRightLuma;   /* Dynamic */
        U32 ThresholdScd;
        U32 ThresholdRfd;
        U32 ThresholdMove;
        U32 ThresholdCfd;
    ...
    struct
    {
        ...
        U32 DcdiConfig;
        U32 PrevLuma;           /* Dynamic */
        U32 PrevEnhLuma;           /* Dynamic */
        U32 PrevRightLuma;           /* Dynamic */
        U32 PrevEnhRightLuma;           /* Dynamic */
        U32 NextLuma;           /* Dynamic */
        U32 NextEnhLuma;           /* Dynamic */
        U32 NextRightLuma;           /* Dynamic */
        U32 NextEnhRightLuma;           /* Dynamic */
        U32 PrevChroma;         /* Dynamic */
        U32 PrevEnhChroma;         /* Dynamic */
        U32 PrevRightChroma;         /* Dynamic */
        U32 PrevEnhRightChroma;         /* Dynamic */
        U32 NextChroma;         /* Dynamic */
        U32 NextEnhChroma;         /* Dynamic */
        U32 NextRightChroma;         /* Dynamic */
        U32 NextEnhRightChroma;         /* Dynamic */
        U32 PrevMotion;         /* Dynamic */
        U32 PrevRightMotion;         /* Dynamic */
        U32 CurMotion;          /* Dynamic */
        U32 CurRightMotion;          /* Dynamic */
        U32 NextMotion;         /* Dynamic */
        U32 NextRightMotion;         /* Dynamic */
    } Csdi;
    struct
    {
        U32 HorPanoramicCtrl;
        ...
        U32 InitVertical;
        U32 ParamCtrl;
/* These LUT are not programmed in the driver, but in the LLD,
   but still makes the structure size too big, so they are commented
   here, and size/memcopy in driver are taking this lack into account
        U32 YhCoef[128];
        U32 ChCoef[128];
        U32 YvCoef[128];
        U32 CvCoef[128]; */
...
} STLAYER_HQVDPLiteCommand_t;

typedef struct STLAYER_HQVDPLite_VideoDisplayParams_s
{
    STLAYER_HQVDPLiteCommand_t  CurrentCmd;
    STLAYER_ZoomFilterSet_t CurrentFilterSet;
    STLAYER_CRCData_t       MisrCRCData;
} STLAYER_HQVDPLite_VideoDisplayParams_t;
...
typedef struct STLAYER_VideoDisplayParams_s
{
    ...
    union
    {
        ...
        STLAYER_HQVDPLite_VideoDisplayParams_t     HQVDPLiteParams;
...
typedef struct STLAYER_DisplaySettings_s
{
    ...
    U32                          PrevPictureSignature;      /* Signature of Previous picture (computed on all the frame) */
    U32                          NextPictureSignature;      /* Signature of Next picture (computed on all the frame) */
...
int stlayer_IPrC_Handler(U32 request, void *arg);
#endif
