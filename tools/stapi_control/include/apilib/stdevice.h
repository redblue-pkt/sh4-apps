...
#endif
#if defined(b2069)&&defined(ST_7111)               /* B2069 board based on 7111               */
#include "b2069_7111.h"
#endif
#if defined(b2068)&&defined(ST_7105)               /* DCT-7167 Platform for STx7167             */
#include "b2068_7105.h"
#endif
...
#endif
#if defined(b2049)&&defined(ST_7105)               /* Verona Platform for STxh261              */
#include "b2049_7105.h"
#endif
...
#endif
#if defined(hdkh225)&&defined(ST_7141)             /* HDKH225 Platform for STx7141              */
#include "hdkh225_7141.h"
#endif
...
#endif
#if defined(b2066)&&defined(ST_7108)              /* B2066 Platform for STx7108                */ 
#include "b2066_7108.h" 
#endif
#if defined(hdk7108)&&defined(ST_H205)             /* hdk7108 Platform for STxH205              */
#include "hdk7108_h205.h"
#endif
#if defined(b2037)&&defined(ST_H205)               /* hdk Platform for STxH205                  */
#include "b2037_h205.h"
#endif
#if defined(b2039)&&defined(ST_H205)               /* mboard for STxH205                        */
#include "b2039_h205.h"
#endif
#if defined(b2057)&&defined(ST_H205)               /* HDK for STxH205 (Liege)                   */
#include "b2057_h205.h"
#endif
#if defined(b2064)&&defined(ST_H205)               /* HDK for STxH239 (Liege)                   */
#include "b2064_h205.h"
#endif
#if defined(ep8000)&&defined(ST_H205)               /* HDK for STxH239 (Newport)                   */
#include "ep8000_h205.h"
#endif
#if defined(epp8000)&&defined(ST_H205)               /* HDK for STxH239 (Newport)                   */
#include "epp8000_h205.h"
#endif
#if defined(gpv8000)&&defined(ST_H205)               /* HDK for STxH253 (Firenze)                   */
#include "gpv8000_h205.h"
#endif
#if defined(b2067)&&defined(ST_H205)               /* HDK for STxH238 (Liege)                   */
#include "b2067_h205.h"
#endif
#if defined(dp2010)&&defined(ST_H205)               /* HDK for STxH237 (Cardiff)                   */
#include "dp2010_h205.h"
#endif
#if defined(dp7000)&&defined(ST_H205)               /* HDK for STxH237 (Cardiff)                   */
#include "dp7000_h205.h"
#endif
#if defined(dp7001)&&defined(ST_H205)               /* HDK for STxH237 (Cardiff)                   */
#include "dp7001_h205.h"
#endif
#if defined(dp7050)&&defined(ST_H205)               /* HDK for STxH237 (Cardiff)                   */
#include "dp7050_h205.h"
#endif
#if defined(fx6010)&&defined(ST_H205)               /* HDK for STxH237 (Cardiff)                   */
#include "fx6010_h205.h"
#endif
#if defined(b2075)&&defined(ST_H205)               /* HDK for STxH205 (Liege)                   */
#include "b2075_h205.h"
#endif
#if defined(b2076)&&defined(ST_H205)               /* mboard for STxH205                        */
#include "b2076_h205.h"
#endif
...
#endif
#if defined(ngb7167)&&defined(ST_7105)             /* NGB Platform based on  STx7167        */
#include "ngb7167_7105.h"
#endif
...
#endif
#if defined(custom003018)&&defined(ST_7108)        /* Custom003018 Platform for STx7108         */
#include "custom003018_7108.h"
#endif
...
#include "hdk7111.h"
#elif defined(b2069)  /* B2069 Evaluation Platform for STx7111 */
#include "b2069.h"
...
#include "hdk7108.h"
#elif defined(b2037)  /* hdk Evaluation Platform for STxH205     */
#include "b2037.h"
#elif defined(b2039)  /* b2039 Evaluation Platform for STxH205     */
#include "b2039.h"
#elif defined(b2057)  /* HDK for STxH205 (Liege)                   */
#include "b2057.h"
#elif defined(b2064)  /* HDK for STxH239 (Liege)                   */
#include "b2064.h"
#elif defined(b2067)  /* HDK for STxH238 (Liege)                   */
#include "b2067.h"
#elif defined(fx6010)  /* HDK for STxH237 (Cardiff)                   */
#include "fx6010.h"
#elif defined(b2075)  /* HDK for STxH207 (Liege)                   */
#include "b2075.h"
#elif defined(b2076)  /* HDK for STxH238 (Liege)                   */
#include "b2076.h"
