...
typedef enum STBLIT_OutlineType_s
{
    /* Types of generated edges */
    STBLIT_SMOOTH_EDGE      = 0x0,
    STBLIT_BOLD_EDGE        = 0x1,
    STBLIT_FADE_OUT_EDGE    = 0x2,

    /* Edges quality */
    STBLIT_NORMAL_EDGE      = 0x00,
    STBLIT_FINE_EDGE        = 0x10,
    STBLIT_EXTRA_FINE_EDGE  = 0x20,

    /* Enable 3d edges */
    STBLIT_3D_EDGE          = 0x100
} STBLIT_OutlineType_t;
...
typedef struct STBLIT_OutlineEffect_s
{
    U32                     OutlineThickness;
    S32                     DropShadowHorizontal;
    S32                     DropShadowVertical;
    STGXOBJ_Color_t         OutlineEffectColor;
    STBLIT_OutlineType_t    OutlineType;
    void*                   TemporaryBufferAddr_p;
    U32                     TemporaryBufferSize;
} STBLIT_OutlineEffect_t;
...
ST_ErrorCode_t STBLIT_SetRotationAngle(STBLIT_Handle_t Handle, U32 RotationAngle);

ST_ErrorCode_t STBLIT_OutlineEffect(STBLIT_Handle_t         Handle,
                                    STBLIT_Destination_t*   DstBitmap_p,
                                    STBLIT_Source_t*        SrcBitmap_p,
                                    STBLIT_BlitContext_t*   BlitContext_p,
                                    STBLIT_OutlineEffect_t* OutlineEffect_p);
...
/* Flicker Filter On S1 */
ST_ErrorCode_t STBLIT_DisableFlickerFilterOnS1(STBLIT_Handle_t    Handle);
ST_ErrorCode_t STBLIT_EnableFlickerFilterOnS1(STBLIT_Handle_t    Handle);

/* Boundary Bypass */
ST_ErrorCode_t STBLIT_DisableBoundaryBypass(STBLIT_Handle_t    Handle);
ST_ErrorCode_t STBLIT_EnableBoundaryBypass(STBLIT_Handle_t    Handle);

/* Frame 2 Field */
ST_ErrorCode_t STBLIT_DisableFrame2Field(STBLIT_Handle_t    Handle);
ST_ErrorCode_t STBLIT_EnableFrame2Field(STBLIT_Handle_t    Handle);
