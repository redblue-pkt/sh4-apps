...
#include "stgxobj.h"
#include "stvout.h"
#include "staudlx.h"    /* Is now the only audio driver !*/
...
#define STHDMI_VENDORNAME_LENGTH  8   /* Vendor Name buffer */
#define STHDMI_PRODUCTDSC_LENGTH  16  /* Product description buffer */
...
typedef enum STHDMI_AVIInfoFrameFormat_e
{
	...
	STHDMI_AVI_INFOFRAME_ADVANCED_FORMAT_VER_TWO=8
...
typedef enum STHDMI_GamutMetaDataFormat_e
{
	STHDMI_GAMUTMETADATA_FORMAT_NONE    =1,
	STHDMI_GAMUTMETADATA_FORMAT_VER_ONE =2
}STHDMI_GamutMetaDataFormat_t;

typedef enum STHDMI_BarInfo_e
{
	STHDMI_BAR_INFO_NOT_VALID,      /* Bar Data not valid */
	STHDMI_BAR_INFO_V,              /* Vertical bar data valid */
    STHDMI_BAR_INFO_H,              /* Horizontal bar data valid */
    STHDMI_BAR_INFO_VH              /* Horizontal and Vertical bar data valid */
}STHDMI_BarInfo_t;
...
typedef enum STHDMI_PictureScaling_e
{
    ...
    STHDMI_PICTURE_SCALING_H,                /* Picture has been scaled horizontally */
	STHDMI_PICTURE_SCALING_V,                /* Picture has been scaled Vertically */
    STHDMI_PICTURE_SCALING_HV                /* Picture has been scaled Horizontally and Vertically   */
}STHDMI_PictureScaling_t;

typedef enum STHDMI_RGBQuantizationRange_e
{
    STHDMI_QUANTIZATION_DEFAULT_RANGE,  /* Default range, it depends on the video format */
    STHDMI_QUANTIZATION_LIMITED_RANGE,  /* Limited quantization range of 220 levels when receiving a CE video format*/
    STHDMI_QUANTIZATION_FULL_RANGE      /* Full quantization range of 256 levels when receiving an IT video format*/

}STHDMI_QuantizationRange_t;
...
typedef enum STHDMI_SPDDeviceInfo_e
{
	...
	STHDMI_SPD_DEVICE_BLU_RAY_DISC,
	STHDMI_SPD_DEVICE_SUPER_AUDIO_CD,
	STHDMI_SPD_DEVICE_HD_DVD,
	STHDMI_SPD_DEVICE_PMP
...
typedef enum STHDMI_EDIDDecodeStereo_e
{
    ...
    STHDMI_EDID_STEREO_RIGHT_IMAGE,           /* Field Sequential stereo, right image when stereo sync=1 */
    STHDMI_EDID_STEREO_LEFT_IMAGE,            /* Field Sequential stereo, left image when stereo sync =1 */
...
typedef enum STHDMI_CEC_AbortReason_e
{
    ...
    STHDMI_CEC_ABORT_REASON_UNABLE_TO_DETERMINE             = 5
...
{
    /* Old CEC versions 1.1/1.2/1.2a/1.3 were reserved */
    ...
    STHDMI_CEC_CEC_VERSION_1_4_A      = 0x05
...
typedef enum STHDMI_CEC_DeviceType_e
{
    ...
    STHDMI_CEC_DEVICE_TYPE_PURE_CEC_SWITCH          = 6,
    STHDMI_CEC_DEVICE_TYPE_VIDEO_PROCESSOR          = 7
...
typedef enum STHDMI_CEC_UI_BroadcastType_e
{
   STHDMI_CEC_UI_BROADCAST_TYPE_TOGGLING                            =0x00,
   STHDMI_CEC_UI_BROADCAST_TYPE_DIGITAL_ANALOGUE_TOGGLING           =0x01,
   STHDMI_CEC_UI_BROADCAST_TYPE_ANALOGUE                            =0x10,
   STHDMI_CEC_UI_BROADCAST_TYPE_ANALOGUE_TERRESTRIAL                =0x20,
   STHDMI_CEC_UI_BROADCAST_TYPE_ANALOGUE_CABLE                      =0x30,
   STHDMI_CEC_UI_BROADCAST_TYPE_ANALOGUE_SATELLITE                  =0x40,
   STHDMI_CEC_UI_BROADCAST_TYPE_DIGITAL                             =0x50,
   STHDMI_CEC_UI_BROADCAST_TYPE_DIGITAL_TERRESTRIAL                 =0x60,
   STHDMI_CEC_UI_BROADCAST_TYPE_DIGITAL_CABLE                       =0x70,
   STHDMI_CEC_UI_BROADCAST_TYPE_DIGITAL_SATELLITE                   =0x80,
   STHDMI_CEC_UI_BROADCAST_TYPE_DIGITAL_COMMUNICATION_SATELLITE     =0x90,
   STHDMI_CEC_UI_BROADCAST_TYPE_DIGITAL_COMMUNICATION_SATELLITE_2   =0x91,
   STHDMI_CEC_UI_BROADCAST_TYPE_IP                                  =0xA0
}STHDMI_CEC_UI_BroadcastType_t;

typedef enum STHDMI_CEC_UI_SoundPresentation_e
{
   STHDMI_CEC_UI_SOUND_PRESENTATION_MIXING_DUAL_MONO                 =0x20,
   STHDMI_CEC_UI_SOUND_PRESENTATION_MIXING_KARAOKE                   =0x30,
   STHDMI_CEC_UI_SOUND_PRESENTATION_AUDIO_DOWNMIXING                 =0x80,
   STHDMI_CEC_UI_SOUND_PRESENTATION_AUDIO_REVERBERATION_PROCESSING   =0x90,
   STHDMI_CEC_UI_SOUND_PRESENTATION_AUDIO_EQUALIZER                  =0xA0,
   STHDMI_CEC_UI_SOUND_PRESENTATION_BASS_STEP_PLUS                   =0xB1,
   STHDMI_CEC_UI_SOUND_PRESENTATION_BASS_NEUTRAL_POSITION            =0xB2,
   STHDMI_CEC_UI_SOUND_PRESENTATION_BASS_STEP_MINUS                  =0xB3,
   STHDMI_CEC_UI_SOUND_PRESENTATION_TREPLE_STEP_PLUS                 =0xC1,
   STHDMI_CEC_UI_SOUND_PRESENTATION_TREPLE_STEP_NEUTRAL_POSITION     =0xC2,
   STHDMI_CEC_UI_SOUND_PRESENTATION_TREPLE_STEP_MINUS                =0xC3,

}STHDMI_CEC_UI_SoundPresentation_t;

typedef enum STHDMI_3DStructure_e
{
    STHDMI_3D_FRAME_PACKING       = 0x01,
    STHDMI_3D_FIELD_ALTERNATIVE   = 0x02,
    STHDMI_3D_LINE_ALTERNATIVE    = 0x04,
    STHDMI_3D_SIDE_BY_SIDE_FULL   = 0x08,
    STHDMI_3D_L_DEPTH             = 0x10,
    STHDMI_3D_L_DEPTH_GFX_GDEPTH  = 0x20,
    STHDMI_3D_TOP_BOTTOM          = 0x40,
    STHDMI_3D_SIDE_BY_SIDE_HALF   = 0x80,
    STHDMI_3D_NONE                = 0x00
}STHDMI_3DStructure_t;

typedef enum STHDMI_3DDataExtension_e
{
   STHDMI_3D_EXT_NONE,
   STHDMI_3D_EXT_ALL_COMBINATIONS,
   STHDMI_3D_EXT_ALL_H_SUB_SAMPLING,
   STHDMI_3D_EXT_H_SUB_SAMPLING_OLP_ORP,       /* Horizental Sub-Sumpling Odd/Left Picture, Odd/Right Picture */
   STHDMI_3D_EXT_H_SUB_SAMPLING_OLP_ERP,       /* Horizental Sub-Sumpling Odd/Left Picture, Even/Right Picture */
   STHDMI_3D_EXT_H_SUB_SAMPLING_ELP_ORP,       /* Horizental Sub-Sumpling Even/Left Picture, Odd/Right Picture */
   STHDMI_3D_EXT_H_SUB_SAMPLING_ELP_ERP,       /* Horizental Sub-Sumpling Even/Left Picture, Even/Right Picture */
   STHDMI_3D_EXT_ALL_QUINCUNX_MATRIX,
   STHDMI_3D_EXT_QUINCUNX_MATRIX_OLP_ORP,       /* QUINCUNX MTRIX Odd/Left Picture, Odd/Right Picture */
   STHDMI_3D_EXT_QUINCUNX_MATRIX_OLP_ERP,       /* QUINCUNX MTRIX Odd/Left Picture, Even/Right Picture */
   STHDMI_3D_EXT_QUINCUNX_MATRIX_ELP_ORP,       /* QUINCUNX MTRIX Even/Left Picture, Odd/Right Picture */
   STHDMI_3D_EXT_QUINCUNX_MATRIX_ELP_ERP        /* QUINCUNX MTRIX Even/Left Picture, Even/Right Picture*/
}STHDMI_3DDataExtension_t;

typedef enum STHDMI_VideoFormat_e
{
   STHDMI_VS_NO_ADDITIONAL_VIDEO_FORMAT,           /* No additional HDMI video format is presented in this packet*/
   STHDMI_VS_EXTENDED_VIDEO_FORMAT,                /* Extended resolution format (eg 4K*2K*video format) present */
   STHDMI_VS_3D_VIDEO_FORMAT                       /* 3D format indication present */
}STHDMI_VideoFormat_t;

typedef enum STHDMI_ImageSizeOption_e
{
   STHDMI_IMAGE_SIZE_NONE,                         /* No additional information */
   STHDMI_IMAGE_SIZE_OPTION_1,                     /* Value in the image Size area indicate correct aspect ratio but the size are not guranteed to be correct */
   STHDMI_IMAGE_SIZE_OPTION_2,                     /* Value in the image Size area indicate correct sizes which are rounded to ~ 1cm */
   STHDMI_IMAGE_SIZE_OPTION_3                      /* Value in the image Size area indicate correct sizes in divided by 5 format ~5cm */
}STHDMI_ImageSizeOption_t;

typedef enum STHDMI_ContentType_e
{
    STHDMI_CONTENT_TYPE_NO_DATA,
    STHDMI_CONTENT_TYPE_GFX,
    STHDMI_CONTENT_TYPE_PHOTO,
    STHDMI_CONTENT_TYPE_CINEMA,
    STHDMI_CONTENT_TYPE_GAME
}STHDMI_ContentType_t;

typedef enum STHDMI_PlayBackLevel_e
{
    STHDMI_LFEPBL_NO_INFOMATION,
    STHDMI_LFEPBL_0_DB,
    STHDMI_LFEPBL_10_DB
}STHDMI_PlayBackLevel_t;
...
typedef struct STHDMI_AVIInfoFrameAdvancedVer2_s
{
	STHDMI_InfoFrameType_t         FrameType;
	U32                            FrameVersion ;
	U32                            FrameLength;
	...
	STGXOBJ_AspectRatio_t          ActiveAspectRatio;
	STHDMI_PictureScaling_t        PictureScaling;
    STHDMI_QuantizationRange_t     RGBQuantization;
    STHDMI_QuantizationRange_t     YCCQuantization;
    BOOL                           IsITContent;
    U32                            VideoFormatIDCode;
    U32                            PixelRepetition;
    STHDMI_ContentType_t           ContentType;
	U32                            LineNEndofTopLower;
	U32                            LineNEndofTopUpper;
	U32                            LineNStartofBotLower;
	U32                            LineNStartofBotUpper;
	...
	U32                            PixelNStartofRightLower;
	U32                            PixelNStartofRightUpper;
}STHDMI_AVIInfoFrameAdvancedVer2_t;

typedef union STHDMI_AVIInfoFrame_u
{
	STHDMI_AVIInfoFrameVer1_t           AVI861A;  /* AVI info frame version1 for EIA/CEA 861A Support */
	STHDMI_AVIInfoFrameVer2_t           AVI861B;  /* AVI Info frame verison2 for EIA/CEA 861B & 861C Support*/
	STHDMI_AVIInfoFrameAdvancedVer2_t   AVI861D;  /* AVI Info frame verison2 for EIA/CEA 861D Support*/
...
typedef struct STHDMI_SPDInfoFrame_s
{
	...
	char                     ProductDescription[STHDMI_PRODUCTDSC_LENGTH];
...
typedef struct STHDMI_3DParallax_s
{
    U32 Parallax_zero;
    U32 Parallax_scale;
    U32 Dref;
...
typedef struct STHDMI_3DMetaData_s
{
  U8 Type;
  U8 Length;
  union
  {
    STHDMI_3DParallax_t  Parallax;
  }Data;
}STHDMI_3DMetaData_t;
...
typedef struct STHDMI_VendorSpecificInfoFrame_s
{
	...
	U32                      FrameLength;
    U32                      RegistrationId;
    STHDMI_VideoFormat_t     HDMIVideoFormat;
    U32                      HDMIVic;
    STHDMI_3DStructure_t     HDMI3DStructure;
    STHDMI_3DDataExtension_t HDMI3DExtension;
    BOOL                     IsHDMI3DMetaPresent;
    STHDMI_3DMetaData_t      HDMI3DMetaData;
}STHDMI_VendorSpecInfoFrame_t;

typedef enum STHDMI_GamutPacketSequence_e
{
   STHDMI_GAMUT_INTERMEDIATE_PACKET_IN_SEQ,
   STHDMI_GAMUT_FIRST_PACKET_IN_SEQ,
   STHDMI_GAMUT_LAST_PACKET_IN_SEQ,
   STHDMI_GAMUT_ONLY_PACKET_IN_SEQ
}STHDMI_GamutPacketSequence_t;

typedef enum STHDMI_GDB_ColorPrecision_e
{
    STHDMI_COLOR_PERCISION_8BIT,
    STHDMI_COLOR_PERCISION_10BIT,
    STHDMI_COLOR_PERCISION_12BIT
}STHDMI_GDB_ColorPrecision_t;

typedef struct STHDMI_GDB_Profile_s
{
    STVOUT_InfoFrameType_t  Gamut_Profile;
	U16                     VsyncPacketsNbr;
	U16                     TotalPacketsNbr;
}STHDMI_GDB_Profile_t;

typedef struct STHDMI_GamutMetaData_s
{
    STHDMI_GDB_Profile_t          Profile;
    BOOL                          NextField :1;
    BOOL                          NoCurrentGDB :1;
    U8                            AffectedGamutSeqNum :4;
    U8                            CurrentGamutSeqNum :4;
    STHDMI_GamutPacketSequence_t  PaquetSequence :2;
    BOOL                          FormatFlag :1;
    BOOL                          FacetMode :1;
    STHDMI_GDB_ColorPrecision_t   GDBColorPrecision :2;
    STVOUT_ColorSpace_t           ColorSpace;
    U16                           NumberVertices;
    U16                           NumberFacets;
    U8*                           PackedVerticesData_p;
    U8*                           PackedFacetsData_p;
    U16                           Min_Red_Data;
    U16                           Max_Red_Data;
    U16                           Min_Green_Data;
    U16                           Max_Green_Data;
...
typedef struct STHDMI_VendorDataBlock_s
{
    ...
    U8   VendorLength;
    U8   RegistrationId[3];
    U16   VideoLatency;                   /* Indicates the amount of video latency */
    U16   AudioLatency;                   /* Indicates the amount of audio latency */
    U16   InterlacedVideoLatency;         /* indicates interlaced Video latency */
    U16   InterlacedAudioLatency;         /* indicates interlaced Audio latency */
    U32  MaxTMDSClock;                   /* Maximum pixel clock rate at the maximum color depth */
    BOOL IsAISupported;
    BOOL IsDC48bitsSupported;            /* If the sink supports 48 bits/pixel (16bits/color)*/
    BOOL IsDC36bitsSupported;            /* If the sink supports 36 bits/pixel (12bits/color)*/
    BOOL IsDC30bitsSupported;            /* If the sink supports 30 bits/pixel (10bits/color)*/
    BOOL IsDCY444Supported;              /* If the sink supports YCbCr 4:4:4 in deep color modes */
    BOOL IsDVIDualLink;                  /* If the sink supports DVI dual link operation */
    STHDMI_CEC_PhysicalAddress_t PhysicalAddress;
    U8* VendorData_p;
}STHDMI_VendorDataBlock_t;

typedef struct STHDMI_Sink3DCapabilities_s
{
    STHDMI_3DStructure_t       Vic3DStructure;
    STHDMI_3DDataExtension_t   Vic3DDataExt;
}STHDMI_Sink3DCapabilities_t;


typedef struct STHDMI_VendorDataBlock861D_s
{
    U8   TagCode;
    U8   VendorLength;
    U8   RegistrationId[3];
    ...
    U16  InterlacedVideoLatency;         /* indicates interlaced Video latency */
    U16  InterlacedAudioLatency;         /* indicates interlaced Audio latency */
    U8   HDMIVICLength;                  /* HDMI Video formats supported length */
    U8   HDMI3DLength;                   /* HDMI 3D video formats supported length */
    U32  MaxTMDSClock;                   /* Maximum pixel clock rate at the maximum color depth */
    BOOL IsAISupported;
    BOOL IsDC48bitsSupported;            /* If the sink supports 48 bits/pixel (16bits/color)*/
    BOOL IsDC36bitsSupported;            /* If the sink supports 36 bits/pixel (12bits/color)*/
    ...
    BOOL IsDCY444Supported;              /* If the sink supports YCbCr 4:4:4 in deep color modes */
    BOOL IsDVIDualLink;                  /* If the sink supports DVI dual link operation */
    BOOL IsGFXProcessingSupported;       /* The sink has specific processing for graphics */
    BOOL IsPhotoProcessingSupported;     /* The sink has specific processing for photos */
    BOOL IsCinemaProcessingSupported;    /* The sink has specific processing for cinema */
    BOOL IsGameProcessingSupported;      /* The sink has specific processing for game */
    BOOL Is3DSinkCapable;                /* The sink is 3D capable */
    STHDMI_ImageSizeOption_t     ImageSize;  /* indicates additional properties of the values in the image size */
    STHDMI_CEC_PhysicalAddress_t PhysicalAddress;
    STHDMI_Sink3DCapabilities_t  Sink3DData[16];
    U8*  HDMIVICData_p;                  /* This field indicates the video formats which are supported by the sink */
	U8*  VendorData_p;
}STHDMI_VendorDataBlock861D_t;           /* Vendor data block compliant to CEA 861 rev D */


typedef struct STHDMI_ColorimetryDataBlock_s
{
	BOOL IsxvYCC601Supported;
	BOOL IsxvYCC709Supported;
    BOOL IssYCC601Supported;
    BOOL IsAdobeYCC601Supported;
    BOOL IsAdobeRGBSupported;
	U8   MetaDataProfile;
}STHDMI_ColorimetryDataBlock_t;

typedef struct STHDMI_VideoCapaDataBlock_s
{
    U8    CEScanInfo;                      /* CE overscan/underscan behavior, applies to CE video format */
    U8    ITScanInfo;                      /* IT overscan/underscan behavior, applies to IT video format */
    U8    PTScanInfo;                      /* PT overscan/underscan behavior, applies to preffered video format */
    BOOL  IsQRYCCSelectable;               /* Quantization range for YCC is selectable via AVI */
    BOOL  IsQRRGBSelectable;               /* Quantization range for RGB is selectable via AVI */
}STHDMI_VideoCapaDataBlock_t;
...
typedef struct STHDMI_DataBlockCollection_s
{
    ...
    STHDMI_ColorimetryDataBlock_t  ColorimetryData;
    STHDMI_VideoCapaDataBlock_t    VideoCapaData;
}STHDMI_DataBlockCollection_t;

typedef struct STHDMI_DataBlockCollection861D_s
{
    STHDMI_VideoDataBlock_t        VideoData;
    STHDMI_AudioDataBlock_t        AudioData;
    STHDMI_SpeakerAllocation_t     SpeakerData;
    STHDMI_VendorDataBlock861D_t   VendorData;
    STHDMI_ColorimetryDataBlock_t  ColorimetryData;
    STHDMI_VideoCapaDataBlock_t    VideoCapaData;
}STHDMI_DataBlockCollection861D_t;
...
typedef struct STHDMI_EDIDTimingAdvancedExtVer3_s
{
	U32    Tag;
	U32    RevisionNumber;
	U32    Offset;
	U32    Checksum;
	STHDMI_EDIDSinkParams_t            FormatDescription;
	STHDMI_DataBlockCollection861D_t   DataBlock;
	U32                                NumberOfTiming;
	STHDMI_EDIDTimingDescriptor_t*     TimingDesc_p;
}STHDMI_EDIDTimingAdvancedExtVer3_t;
...
typedef union STHDMI_EDIDTimingExt_u
{
	...
	STHDMI_EDIDTimingAdvancedExtVer3_t EDID861D;
...
typedef enum STHDMI_EDIDDescriptorType_s
{
   STHDMI_EDID_DESCRIPTOR_TYPE_DETAILED_TIMING,
   STHDMI_EDID_DESCRIPTOR_TYPE_MONITOR
}STHDMI_EDIDDescriptorType_t;

typedef struct STHDMI_EDIDDescriptor_s
{
   STHDMI_EDIDDescriptorType_t  type;
   union
   {
      STHDMI_MonitorDescriptorExt_t  MonitorBlock;
      STHDMI_EDIDTimingDescriptor_t  TimingDesc;
   }Descriptor;
}STHDMI_EDIDDescriptor_t;
...
typedef struct STHDMI_EDIDStructure_s
{
    ...
    STHDMI_EDIDDescriptor_t         EDIDDetailedDesc[4];
...
typedef struct STHDMI_InitParams_s
{
	...
	union
	{
        ...
        /* TBD... reserved for future use */   /* for target on silicon image chip(e.g : SIL9190) */
	}Target;
	...
	STHDMI_GamutMetaDataFormat_t   GBDType;
}STHDMI_InitParams_t;
...
typedef union STHDMI_CEC_UIC_Operand_u
{
    ...
    STHDMI_CEC_UI_SoundPresentation_t UISoundPresentationControl;
...
typedef union STHDMI_CEC_Operand_u
{
    ...
    STHDMI_CEC_UI_BroadcastType_t              UIBroadcastType;
...
/* This exported area only needs the C++ decoration removal attribute ! */
#ifdef __cplusplus
extern "C" {
#endif
...
ST_ErrorCode_t STHDMI_FillGamutMetaData(
               const STHDMI_Handle_t                Handle,
               STHDMI_GamutMetaData_t*              const GamutBuffer_p
               );
