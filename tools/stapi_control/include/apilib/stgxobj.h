...
typedef enum STGXOBJ_AspectRatio_e
{
  ...
  STGXOBJ_ASPECT_RATIO_SAME_AS_PICTURE = 6,
  STGXOBJ_ASPECT_RATIO_4TO3_SP_14TO9  = 7,
  STGXOBJ_ASPECT_RATIO_16TO9_SP_14TO9 = 8,
  STGXOBJ_ASPECT_RATIO_16TO9_SP_4TO3  = 9,
...
#ifdef ST_VALIDATION 
  STGXOBJ_COLOR_TYPE_BD_RLD,
  STGXOBJ_COLOR_TYPE_H2_RLD,
  STGXOBJ_COLOR_TYPE_H8_RLD
#endif
