...
/**
 * @file     main.c
 * @brief    This is the main entry point of the STAPI Software development kit
...
int main(int argc,char *argv[])
{
 ...
 /* Return error code */
 /* ----------------- */
 if (ErrCode==ST_NO_ERROR) return(0); else return(-1);
}
#endif
...
ST_ErrorCode_t STSDK_Init(U32 SDK_Mode)
{
 ...
 if (SDK_Mode&SDK_INIT_DRIVER_LAYER)
  {
   ...
   if ( DMA_Init       ( )!= ST_NO_ERROR )             ErrDriverLayer[0] |= (1<<10); /* Configure the DMA engines               */      
   if ( PCPD_Init      ( )!= ST_NO_ERROR )             ErrDriverLayer[0] |= (1<<11); /* Configure the PCPD driver               */
   if ( SCART_Init     ( )!= ST_NO_ERROR )             ErrDriverLayer[0] |= (1<<12); /* Configure the SCARTs                    */
   if ( TUNER_Init     ( )!= ST_NO_ERROR )             ErrDriverLayer[0] |= (1<<13); /* Configure the Tuners                    */
   ...
   if ( SmoothStreaming_Init ( )!= ST_NO_ERROR )       ErrDriverLayer[1] |= (1<<12); /* Configure the smoothstreaming interface */
  }
 ...
 if (SDK_Mode&SDK_INIT_SECURITY)
  {
   if ( SECMODULES_Init ( )!= ST_NO_ERROR )          ErrModuleLayer[0] |= (1<< 0); /* Initialize the secmodules               */
  }
 ...
 if ((ErrDriverLayer[0]!=0)||(ErrDriverLayer[1]!=0))
  {
   ...
   if (ErrDriverLayer[0] & (1<< 0)) print("          - SYS_Init()       Failure\n");
   if (ErrDriverLayer[0] & (1<< 1)) print("          - PIO_Init()       Failure\n");
   if (ErrDriverLayer[0] & (1<< 2)) print("          - UART_Init()      Failure\n");
   if (ErrDriverLayer[0] & (1<< 3)) print("          - TBX_Init()       Failure\n");
   if (ErrDriverLayer[0] & (1<< 4)) print("          - TRACE_Init()     Failure\n");
   if (ErrDriverLayer[0] & (1<< 5)) print("          - EVT_Init()       Failure\n");
   if (ErrDriverLayer[0] & (1<< 6)) print("          - I2C_Init()       Failure\n");
   if (ErrDriverLayer[0] & (1<< 7)) print("          - SPI_Init()       Failure\n");
   if (ErrDriverLayer[0] & (1<< 8)) print("          - PWM_Init()       Failure\n");
   if (ErrDriverLayer[0] & (1<< 9)) print("          - FLASH_Init()     Failure\n");
   if (ErrDriverLayer[0] & (1<<10)) print("          - DMA_Init()       Failure\n");   
   if (ErrDriverLayer[0] & (1<<11)) print("          - PCPD_Init()      Failure\n");
   if (ErrDriverLayer[0] & (1<<12)) print("          - SCART_Init()     Failure\n");
   if (ErrDriverLayer[0] & (1<<13)) print("          - TUNER_Init()     Failure\n");   
   if (ErrDriverLayer[0] & (1<<14)) print("          - DEMUX_Init()     Failure\n");
   if (ErrDriverLayer[0] & (1<<15)) print("          - INJECT_Init()    Failure\n");
   if (ErrDriverLayer[0] & (1<<16)) print("          - CLKRV_Init()     Failure\n");
   if (ErrDriverLayer[0] & (1<<17)) print("          - DENC_Init()      Failure\n");
   if (ErrDriverLayer[0] & (1<<18)) print("          - VTG_Init()       Failure\n");
   if (ErrDriverLayer[0] & (1<<19)) print("          - VOUT_Init()      Failure\n");
   if (ErrDriverLayer[0] & (1<<20)) print("          - LAYER_Init()     Failure\n");
   if (ErrDriverLayer[0] & (1<<21)) print("          - VBI_Init()       Failure\n");
   if (ErrDriverLayer[0] & (1<<22)) print("          - BLIT_Init()      Failure\n");
   if (ErrDriverLayer[0] & (1<<23)) print("          - GRAFIX_Init()    Failure\n");
   if (ErrDriverLayer[0] & (1<<24)) print("          - VMIX_Init()      Failure\n");
   if (ErrDriverLayer[0] & (1<<25)) print("          - VID_Init()       Failure\n");
   if (ErrDriverLayer[0] & (1<<26)) print("          - AUD_Init()       Failure\n");
   if (ErrDriverLayer[0] & (1<<27)) print("          - BLAST_Init()     Failure\n");
   if (ErrDriverLayer[0] & (1<<28)) print("          - USB_Init()       Failure\n");
   if (ErrDriverLayer[0] & (1<<29)) print("          - GAMLOAD_Init()   Failure\n");
   if (ErrDriverLayer[1] & (1<< 0)) print("          - CRYPT_Init()     Failure\n");
   if (ErrDriverLayer[1] & (1<< 1)) print("          - ATAPI_Init()     Failure\n");
   if (ErrDriverLayer[1] & (1<< 2)) print("          - SMART_Init()     Failure\n");
   if (ErrDriverLayer[1] & (1<< 3)) print("          - HDMI_Init()      Failure\n");
   if (ErrDriverLayer[1] & (1<< 4)) print("          - KEYSCN_Init()    Failure\n");
   if (ErrDriverLayer[1] & (1<< 5)) print("          - VIN_Init()       Failure\n");
   if (ErrDriverLayer[1] & (1<< 6)) print("          - TTX_Init()       Failure\n");
   if (ErrDriverLayer[1] & (1<< 7)) print("          - CC_Init()        Failure\n");
   if (ErrDriverLayer[1] & (1<< 8)) print("          - POD_Init()       Failure\n");
   if (ErrDriverLayer[1] & (1<< 9)) print("          - MOCA_Init()      Failure\n");
   if (ErrDriverLayer[1] & (1<<10)) print("          - PCCRD_Init()     Failure\n");
   if (ErrDriverLayer[1] & (1<<11)) print("          - GRAFIX_DFBInit() Failure\n");
  }
 if ((ErrMiddleLayer[0]!=0)||(ErrMiddleLayer[1]!=0))
  {
   ...
   if (ErrMiddleLayer[0] & (1<< 0)) print("          - TCPIP_Init()   Failure\n");
   if (ErrMiddleLayer[0] & (1<< 1)) print("          - VFS_Init()     Failure\n");
   if (ErrMiddleLayer[0] & (1<< 2)) print("          - PLAYREC_Init() Failure\n");
   if (ErrMiddleLayer[0] & (1<< 3)) print("          - SUBT_Init()    Failure\n");
  }
 if ((ErrModuleLayer[0]!=0)||(ErrModuleLayer[1]!=0))
  {
   ...
   if (ErrModuleLayer[0] & (1<< 0)) print("          - MODULES_Init() Failure\n");
  }
 if ((ErrAppliLayer[0]!=0)||(ErrAppliLayer[1]!=0))
  {
   ...
   if (ErrAppliLayer[0] & (1<< 0)) print("          - GUI_Init()      Failure\n");
  }
...
ST_ErrorCode_t STSDK_Term(U32 SDK_Mode)
{
 ...
 if (SDK_Mode&SDK_TERM_SECURITY)
  {
   if ( SECMODULES_Term ( )!= ST_NO_ERROR )          ErrModuleLayer[0] |= (1<< 0); /* Terminate the secmodules               */
  }
 ...
 if (SDK_Mode&SDK_TERM_DRIVER_LAYER)
  {
   if ( SmoothStreaming_Term ( )!= ST_NO_ERROR )       ErrDriverLayer[1] |= (1<< 12);/* Terminate the smoothstreaming interface */
   ...
   if ( TUNER_Term     ( )!= ST_NO_ERROR )             ErrDriverLayer[0] |= (1<<13); /* Terminate the Tuners                    */
   if ( SCART_Term     ( )!= ST_NO_ERROR )             ErrDriverLayer[0] |= (1<<12); /* Terminate the SCARTs                    */
   if ( PCPD_Term      ( )!= ST_NO_ERROR )             ErrDriverLayer[0] |= (1<<11); /* Terminate the PCPD driver               */
   if ( DMA_Term       ( )!= ST_NO_ERROR )             ErrDriverLayer[0] |= (1<<10); /* Terminate the DMA engines               */      
   ...
   if ( EVT_Term       ( )!= ST_NO_ERROR )             ErrDriverLayer[0] |= (1<< 5); /* Terminate the Event handler             */
 ...
 if ((ErrAppliLayer[0]!=0)||(ErrAppliLayer[1]!=0))
  {
   ...
   if (ErrAppliLayer[0] & (1<< 0)) print("          - GUI_Term()      Failure\n");
  }
 if ((ErrModuleLayer[0]!=0)||(ErrModuleLayer[1]!=0))
  {
   ...
   if (ErrModuleLayer[0] & (1<< 0)) print("          - MODULES_Term() Failure\n");
  }
 if ((ErrMiddleLayer[0]!=0)||(ErrMiddleLayer[1]!=0))
  {
   ...
   if (ErrMiddleLayer[0] & (1<< 0)) print("          - TCPIP_Term()   Failure\n");
   if (ErrMiddleLayer[0] & (1<< 1)) print("          - VFS_Term()     Failure\n");
   if (ErrMiddleLayer[0] & (1<< 2)) print("          - PLAYREC_Term() Failure\n");
   if (ErrMiddleLayer[0] & (1<< 3)) print("          - SUBT_Term()    Failure\n");
  }
 if ((ErrDriverLayer[0]!=0)||(ErrDriverLayer[1]!=0))
  {
   ...
   if (ErrDriverLayer[1] & (1<<11)) print("          - GRAFIX_DFBInit() Failure\n");
   if (ErrDriverLayer[1] & (1<<10)) print("          - PCCRD_Term()     Failure\n");
   if (ErrDriverLayer[1] & (1<< 9)) print("          - MOCA_Term()      Failure\n");
   if (ErrDriverLayer[1] & (1<< 8)) print("          - POD_Term()       Failure\n");
   if (ErrDriverLayer[1] & (1<< 7)) print("          - CC_Term()        Failure\n");
   if (ErrDriverLayer[1] & (1<< 6)) print("          - TTX_Term()       Failure\n");
   if (ErrDriverLayer[1] & (1<< 5)) print("          - VIN_Term()       Failure\n");
   if (ErrDriverLayer[1] & (1<< 4)) print("          - KEYSCN_Term()    Failure\n");
   if (ErrDriverLayer[1] & (1<< 3)) print("          - HDMI_Term()      Failure\n");
   if (ErrDriverLayer[1] & (1<< 2)) print("          - SMART_Term()     Failure\n");
   if (ErrDriverLayer[1] & (1<< 1)) print("          - ATAPI_Term()     Failure\n");
   if (ErrDriverLayer[1] & (1<< 0)) print("          - CRYPT_Term()     Failure\n");
   if (ErrDriverLayer[0] & (1<<29)) print("          - GAMLOAD_Term()   Failure\n");
   if (ErrDriverLayer[0] & (1<<28)) print("          - USB_Term()       Failure\n");
   if (ErrDriverLayer[0] & (1<<27)) print("          - BLAST_Term()     Failure\n");
   if (ErrDriverLayer[0] & (1<<26)) print("          - AUD_Term()       Failure\n");
   if (ErrDriverLayer[0] & (1<<25)) print("          - VID_Term()       Failure\n");
   if (ErrDriverLayer[0] & (1<<24)) print("          - VMIX_Term()      Failure\n");
   if (ErrDriverLayer[0] & (1<<23)) print("          - GRAFIX_Term()    Failure\n");
   if (ErrDriverLayer[0] & (1<<22)) print("          - BLIT_Term()      Failure\n");
   if (ErrDriverLayer[0] & (1<<21)) print("          - VBI_Term()       Failure\n");
   if (ErrDriverLayer[0] & (1<<20)) print("          - LAYER_Term()     Failure\n");
   if (ErrDriverLayer[0] & (1<<19)) print("          - VOUT_Term()      Failure\n");
   if (ErrDriverLayer[0] & (1<<18)) print("          - VTG_Term()       Failure\n");
   if (ErrDriverLayer[0] & (1<<17)) print("          - DENC_Term()      Failure\n");
   if (ErrDriverLayer[0] & (1<<16)) print("          - CLKRV_Term()     Failure\n");
   if (ErrDriverLayer[0] & (1<<15)) print("          - INJECT_Term()    Failure\n");
   if (ErrDriverLayer[0] & (1<<14)) print("          - DEMUX_Term()     Failure\n");
   if (ErrDriverLayer[0] & (1<<13)) print("          - TUNER_Init()     Failure\n");
   if (ErrDriverLayer[0] & (1<<12)) print("          - SCART_Term()     Failure\n");
   if (ErrDriverLayer[0] & (1<<11)) print("          - PCPD_Term()      Failure\n");
   if (ErrDriverLayer[0] & (1<<10)) print("          - DMA_Term()       Failure\n");   
   if (ErrDriverLayer[0] & (1<< 9)) print("          - FLASH_Term()     Failure\n");
   if (ErrDriverLayer[0] & (1<< 8)) print("          - PWM_Term()       Failure\n");
   if (ErrDriverLayer[0] & (1<< 7)) print("          - SPI_Term()       Failure\n");
   if (ErrDriverLayer[0] & (1<< 6)) print("          - I2C_Term()       Failure\n");
   if (ErrDriverLayer[0] & (1<< 5)) print("          - EVT_Term()       Failure\n");
   if (ErrDriverLayer[0] & (1<< 4)) print("          - TRACE_Term()     Failure\n");
   if (ErrDriverLayer[0] & (1<< 3)) print("          - TBX_Term()       Failure\n");
   if (ErrDriverLayer[0] & (1<< 2)) print("          - UART_Term()      Failure\n");
   if (ErrDriverLayer[0] & (1<< 1)) print("          - PIO_Term()       Failure\n");
   if (ErrDriverLayer[0] & (1<< 0)) print("          - SYS_Term()       Failure\n");
  }
